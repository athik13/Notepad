            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="inbox-rightbar">
                        <h4 class="page-title">Send a Single SMS</h4>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="phoneNumber" min="7" max="7" maxlength="7" name="phoneNumber" type="tel" autocomplete="off" required>
                                        </div>
